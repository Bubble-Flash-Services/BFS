...
const helmetWashPackages = {
  ...
  premium: {
    ...
    subtitle: "Exclusive service for luxury and high-end helmets. Send us a photo for personalized care.",
    packages: [
      {
        id: 10,
...
export default function HelmetWashDeals() {
  ...
  const handlePremiumContact = () => {
    ...
    alert('Please send the helmet photo through WhatsApp. Our team will contact you shortly with a personalized quote.');
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              {/* Modal Header */}
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold text-gray-900">Premium Helmet Care</h2>
                <button
              ...
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Upload Helmet Photo</h3>
