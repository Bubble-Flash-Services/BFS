    ...
    <>
      ...
      >
        ...
        <div className="py-16 relative">
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8 px-4">
            {/* Quick shine car */}
            <motion.div
              initial={{ opacity: 0, y: 50, scale: 0.9 }}
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-purple-100 via-purple-50 to-fuchsia-100 rounded-2xl border-2 border-purple-300 border-opacity-50 shadow-xl p-8 min-h-[500px] flex flex-col justify-between items-center h-full transition-all duration-300 hover:border-opacity-80 relative overflow-hidden"
            >
              {/* Floating Elements */}
              <motion.div
                animate={{ rotate: -360 }}
              ...
              <motion.div
                ...
                className="absolute bottom-4 left-4 w-8 h-8 bg-fuchsia-400 bg-opacity-20 rounded-full blur-sm"
              />
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => navigate("/key-services")}
                className="bg-gradient-to-r from-[#FFD600] to-[#FFA000] text-black rounded-xl border-2 border-purple-500 px-8 py-3 font-semibold text-lg shadow-lg transition-all duration-300 hover:border-purple-600 mx-auto mt-6"
              >
                Get services
              </motion.button>
            </motion.div>
        ...
        <div className="py-16 relative">
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-4">
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-green-50 via-emerald-50 to-green-50 rounded-2xl border-2 border-green-300 border-opacity-50 shadow-lg p-6 flex flex-col transition-all duration-300 hover:border-opacity-80 relative overflow-hidden cursor-pointer"
              onClick={() => navigate("/services/puc-certificate")}
            >
              <div className="absolute top-0 right-0 w-20 h-20 bg-green-400 bg-opacity-10 rounded-full blur-2xl" />
              <div className="relative z-10">
                ...
                <p className="text-gray-600 mb-4">
                  Get your Pollution Under Control certificate hassle-free
                </p>
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-50 rounded-2xl border-2 border-blue-300 border-opacity-50 shadow-lg p-6 flex flex-col transition-all duration-300 hover:border-opacity-80 relative overflow-hidden cursor-pointer"
              onClick={() => navigate("/services/insurance-assistance")}
            >
              <div className="absolute top-0 right-0 w-20 h-20 bg-blue-400 bg-opacity-10 rounded-full blur-2xl" />
              <div className="relative z-10">
                ...
                <p className="text-gray-600 mb-4">
                  Expert help with vehicle insurance and claims
                </p>
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-purple-50 via-violet-50 to-purple-50 rounded-2xl border-2 border-purple-300 border-opacity-50 shadow-lg p-6 flex flex-col transition-all duration-300 hover:border-opacity-80 relative overflow-hidden cursor-pointer"
              onClick={() => navigate("/services/vehicle-checkup")}
            >
              <div className="absolute top-0 right-0 w-20 h-20 bg-purple-400 bg-opacity-10 rounded-full blur-2xl" />
              <div className="relative z-10">
                <div className="text-4xl mb-4">🔧</div>
                <h3 className="text-2xl font-bold text-gray-800 mb-3">
                  Vehicle Checkup
                ...
                <p className="text-gray-600 mb-4">
                  Comprehensive vehicle health inspection services
                </p>
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-orange-50 via-amber-50 to-orange-50 rounded-2xl border-2 border-orange-300 border-opacity-50 shadow-lg p-6 flex flex-col transition-all duration-300 hover:border-opacity-80 relative overflow-hidden cursor-pointer"
              onClick={() => navigate("/vehicle-accessories")}
            >
              <div className="absolute top-0 right-0 w-20 h-20 bg-orange-400 bg-opacity-10 rounded-full blur-2xl" />
              <div className="relative z-10">
                <div className="text-4xl mb-4">🛠️</div>
                <h3 className="text-2xl font-bold text-gray-800 mb-3">
                  Vehicle Accessories
                ...
                <p className="text-gray-600 mb-4">
                  Quality accessories for your car and bike
                </p>
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-rose-50 via-pink-50 to-rose-50 rounded-2xl border-2 border-rose-300 border-opacity-50 shadow-lg p-6 flex flex-col transition-all duration-300 hover:border-opacity-80 relative overflow-hidden cursor-pointer"
              onClick={() => navigate("/painting-services")}
            >
              <div className="absolute top-0 right-0 w-20 h-20 bg-rose-400 bg-opacity-10 rounded-full blur-2xl" />
              <div className="relative z-10">
                <div className="text-4xl mb-4">🎨</div>
                <h3 className="text-2xl font-bold text-gray-800 mb-3">
                  Painting Services
                ...
                <p className="text-gray-600 mb-4">
                  Professional painting and restoration services
                </p>
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-indigo-50 via-blue-50 to-indigo-50 rounded-2xl border-2 border-indigo-300 border-opacity-50 shadow-lg p-6 flex flex-col transition-all duration-300 hover:border-opacity-80 relative overflow-hidden cursor-pointer"
              onClick={() => navigate("/movers-packers")}
            >
              <div className="absolute top-0 right-0 w-20 h-20 bg-indigo-400 bg-opacity-10 rounded-full blur-2xl" />
              <div className="relative z-10">
                <div className="text-4xl mb-4">📦</div>
                <h3 className="text-2xl font-bold text-gray-800 mb-3">
                  Movers & Packers
