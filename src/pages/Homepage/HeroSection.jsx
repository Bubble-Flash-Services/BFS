...
export default function HeroSection() {
  ...
  // Launch Advertisement Modal State - REMOVED for better UX
  ...
  // Launch advertisement modal removed - less intrusive UX
  ...
  // Close launch ad - function removed as modal is disabled
  // const closeLaunchAd = () => {
  ...
  // Accessories data removed - section moved to dedicated page
    // Accessories navigation functions removed
  ...
  return (
    <>
      {/* Launch Advertisement Modal - REMOVED for less intrusive UX */}
      {/* <AnimatePresence>
        {showLaunchAd && (
      ...
      {/* About Us section removed - content was redundant with hero section */}
      {/* Accessories section removed - will be moved to dedicated accessories page */}
            <section
        id="services"
      ...
      >
        ...
        {/* "Choose your package" section removed - redundant with booking form above */}
