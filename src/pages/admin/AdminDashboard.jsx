    ...
    const loadDashboardData = async () => {
      try {
        ...
        const extractPhone = (rb) => {
          ...
          const fromSvcAddr =
            rb?.serviceAddress?.phone || rb?.serviceAddress?.contactPhone;
          const explicit =
            rb?.contactPhone || rb?.phone || rb?.paymentDetails?.contact;
          const fromNotes = (() => {
        ...
        const customersFromRecent = recentBookings.map((rb) => {
          const locRaw =
            rb.serviceAddress?.fullAddress ||
            rb.serviceAddress?.address ||
            rb.userId?.address ||
            "";
          ...
          return {
            ...
            date: rb.createdAt
              ? new Date(rb.createdAt).toISOString().split("T")[0]
              : "N/A",
          };
        });
        ...
        setLoadError(
          "Failed to load dashboard data. Please check your admin authentication and server."
        );
      }
    };
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {dashboardStats.bookingsCount.toLocaleString()}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {dashboardStats.cancellationRequests}
                </p>
              </div>
            </div>
          </div>
            ...
            >
              <div className="flex items-center justify-between text-white">
                <div>
                  ...
                  <p className="text-3xl font-bold mt-2">
                    {serviceBreakdown.vehicleCheckup}
                  </p>
                  <p className="text-xs mt-2 opacity-75">
                    Click to view bookings
                  </p>
            ...
            >
              <div className="flex items-center justify-between text-white">
                <div>
                  ...
                  <p className="text-3xl font-bold mt-2">
                    {serviceBreakdown.vehicleAccessories}
                  </p>
                  <p className="text-xs mt-2 opacity-75">
                    Click to view orders
                  </p>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 mb-8">
          <div className="px-4 md:px-6 py-4 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-600">
              Today's active bookings and services
            </p>
            {loadError && (
            ...
            {currentCustomers.map((c) => (
              <div key={c.id} className="rounded-lg border border-gray-200 p-4">
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div
                    className={`text-xs px-2 py-1 rounded-full ${getServiceModeColor(
                      c.serviceMode
                    )}`}
                  >
                    {c.serviceMode}
                ...
                <div className="mt-3 grid grid-cols-1 gap-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-800">{c.contactNo}</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-800">{c.date}</span>
                  </div>
                </div>
                ...
                {currentCustomers.map((customer) => (
                  <tr key={customer.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      <div className="max-w-xs md:max-w-sm lg:max-w-md text-sm text-gray-900 break-words line-clamp-2">
                        {customer.location}
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span
                        className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getServiceModeColor(
