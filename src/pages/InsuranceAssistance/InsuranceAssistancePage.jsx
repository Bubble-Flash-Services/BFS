...
export default function InsuranceAssistancePage() {
  ...
  const calculatePremium = () => {
    ...
    const vehicleAge = new Date().getFullYear() - parseInt(formData.year || 2020);
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
      ...
      <div className="relative bg-gradient-to-r from-blue-600 to-green-600 text-white py-16 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <FileShield className="w-20 h-20 mx-auto mb-6" />
                    ...
                    {estimatedPremium && (
                      ...
                      >
                        ...
                        <p className="text-xs text-gray-500 mt-2">
                          *This is an approximate calculation. Actual premium may vary based on insurer and other factors.
                        </p>
                      </motion.div>
                    )}
                  </div>
