...
export default function FullBodyCheckup({ type = 'car', compact = false, teaser = false }) {
  ...
  if (teaser) {
    return (
      <div className={`group relative bg-gradient-to-br ${isCar ? 'from-blue-600 via-blue-700 to-blue-800' : 'from-amber-500 via-amber-600 to-amber-700'} rounded-2xl md:rounded-3xl shadow-2xl overflow-hidden transform hover:scale-[1.02] transition-all duration-300`}>
        ...
        <div className="relative z-10 p-6 md:p-12">
          ...
          <div className="flex flex-col md:flex-row items-start gap-4 md:gap-6">
            {/* Icon section */}
            <div className={`flex-shrink-0 w-14 h-14 md:w-20 md:h-20 rounded-xl md:rounded-2xl ${isCar ? 'bg-white/20' : 'bg-white/20'} backdrop-blur-sm flex items-center justify-center text-3xl md:text-5xl shadow-lg`}>
              {isCar ? '🚗' : '🏍️'}
            </div>
            ...
            <div className="flex-1 w-full">
              <div className="flex items-center gap-2 mb-2 md:mb-3">
                ...
                <span className="text-white/90 text-xs md:text-sm font-semibold uppercase tracking-wider">Premium Service</span>
              </div>
              
              <h3 className="text-xl sm:text-2xl md:text-4xl font-extrabold text-white mb-3 md:mb-4 leading-tight">
                BFS Full Body {isCar ? 'Car' : 'Bike'} Checkup
              </h3>
              
              <p className="text-white/90 text-sm sm:text-base md:text-lg mb-4 md:mb-6 leading-relaxed">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 md:gap-3 mb-6 md:mb-8">
                <div className="flex items-center gap-2 text-white/90">
                  ...
                  <span className="text-xs md:text-sm">Professional Inspection</span>
                </div>
                <div className="flex items-center gap-2 text-white/90">
                  <Shield className="w-4 h-4 md:w-5 md:h-5 flex-shrink-0" />
                  <span className="text-xs md:text-sm">Digital Report</span>
                </div>
                <div className="flex items-center gap-2 text-white/90">
              ...
              <button
                ...
                className="group/btn bg-white text-gray-900 hover:bg-gray-100 px-6 py-3 md:px-8 md:py-4 rounded-lg md:rounded-xl font-bold text-base md:text-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-200 flex items-center gap-2 md:gap-3 w-full md:w-auto justify-center"
              >
