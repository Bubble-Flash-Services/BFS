...
const sampleCoupons = [
  // Welcome Coupons
  {
    ...
    description: '10% off on your first wash service. Welcome to Bubble Flash Services!',
  ...
  },
  {
    ...
    description: 'Get ₹50 off on your first service with BFS. Start your journey with us!',
    discountType: 'fixed',
    discountValue: 50,
  ...
  },
  {
    ...
    description: '20% off on car washes during summer. Beat the heat with clean cars!',
    discountType: 'percentage',
    discountValue: 20,
  ...
  // Referral Coupons
  {
    ...
    description: '₹100 off for both you and your friend when they make their first booking!',
    discountType: 'fixed',
    discountValue: 100,
  ...
  },
  {
    ...
    description: 'Exclusive offer for our VIP customers. 15% off on all services.',
    discountType: 'percentage',
    discountValue: 15,
  ...
  // Minimum Order Value Coupons
  {
    ...
    description: '₹75 off on orders above ₹500. Add more services and save more!',
    discountType: 'fixed',
    discountValue: 75,
    minimumOrderAmount: 500,
  ...
  },
  {
    ...
    description: '₹200 off on orders above ₹1000. Perfect for multiple services!',
    discountType: 'fixed',
    discountValue: 200,
  ...
  // Service-Specific Coupons
  {
    ...
    description: '20% off on bike wash services only. Keep your bike sparkling!',
    discountType: 'percentage',
    discountValue: 20,
